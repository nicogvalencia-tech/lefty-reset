  ...
  return (
    <>
      ...
      <main className="font-body">
        ...
        {/* PARTNERS */}
        <section className="bg-[#2B4141] py-12 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-10">
              ...
              <a href="https://11six24.com/nicothelefty" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity duration-200">
                <img src="/images/11SIX24logofinalwhite.svg" alt="11six24" className="h-14 w-auto object-contain" />
              </a>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <a href="https://sqairz.com/discount/nicothelefty" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity duration-200">
                <img src="/images/sqairz_logo_mark_white.png" alt="Sqairz" className="h-[25px] w-auto object-contain" />
              </a>
            </div>
          </div>
        </section>
