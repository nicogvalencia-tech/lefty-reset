# Lefty Reset — Email Sequence
# Load into Kit (ConvertKit) as a sequence called "Lefty Reset Challenge"
# Trigger: subscriber is tagged with "lefty-reset"
...
**Preview:** Welcome to the Lefty Reset — your 60-day transformation starts now.

Hey {{ subscriber.first_name }},

You just made a great decision.

Welcome to the Lefty Reset — the 60-day transformation challenge where pickleball players and fitness-minded people like you show up, do the work, and win together. Over $5,000 in cash and prizes is on the line.

I'm Nico. I built this challenge because I know what it feels like to want to change — and keep putting it off. Not anymore. You signed up. That's step one.

Here's what to do right now:

1. Join the Skool community (free) — this is where everything happens: check-ins, community posts, motivation, and weekly live calls. [Join on Skool →](https://skool.com/theleftyreset)

2. Watch for the April 1 codeword — I'll send it by email and post it on Skool. You'll need it to submit your starting photo and lock in your official entry.
...
The challenge starts April 1. Get ready.

— Nico the Lefty
DUPR Master Instructor · Co-Host of PicklePod

---

## EMAIL 2 — Day 3

**Subject:** Did you get your starting check-in ready?
**Preview:** April 1 is coming. Here's how to make sure you're locked in.

Hey {{ subscriber.first_name }},

Quick check-in before the challenge starts.

The Lefty Reset kicks off on April 1 — and your first job is to submit your Day 1 starting check-in with that day's codeword.
...
What you need:
- Your email (same one you registered with)
- Select "Week 1" from the dropdown
- Your current weight
...
The leaderboard is heating up. Head to nicothelefty.com/leaderboard to see the latest standings — handles only, weights are always private.
...
## EMAIL 5 — Day 21 (Week 3 Check-In)

**Subject:** Halfway through the first month — don't stop now
**Preview:** Week 3 check-in is open. Keep your streak alive.

Hey {{ subscriber.first_name }},

Three weeks in. This is where most people start to slip — and where the winners separate themselves.

If you've been consistent, you already have an edge. Keep it.
...
## EMAIL 6 — Day 28 (Week 4 Check-In)

**Subject:** One month done. Week 4 check-in is open.
**Preview:** You've made it one full month. This is real.

Hey {{ subscriber.first_name }},

One full month. That's not nothing — that's a real commitment.

Take a second to appreciate that. Then go submit your Week 4 check-in.
...
## EMAIL 7 — Day 35 (Week 5 Check-In)

**Subject:** Week 5 — you're in the second half now
**Preview:** Check-in time. Plus a mindset reminder for the stretch run.

Hey {{ subscriber.first_name }},

You're in the second half of the Lefty Reset. Five weeks in.

The results you're seeing now are the foundation for the results you'll see at the end. Don't let up.
...
## EMAIL 8 — Day 42 (Week 6 Check-In)

**Subject:** Week 6 check-in + community shoutouts
**Preview:** The community is showing up. Are you on the board?

Hey {{ subscriber.first_name }},

Six weeks. The transformation is real for a lot of people in this community — and I want to make sure you're one of them.
...
## EMAIL 9 — Day 49 (Week 7 Check-In)

**Subject:** One week left. Make it count.
**Preview:** Final check-in is next week. Here's what you need to know.

Hey {{ subscriber.first_name }},

One week left in the Lefty Reset.

This is it. Give it everything this final week.
...
One more week. Finish strong.

— Nico

---

## EMAIL 10 — Day 56 (Final Check-In Open)

**Subject:** FINAL CHECK-IN IS OPEN — submit before it closes
**Preview:** This is your last chance to lock in your result. Don't miss it.

Hey {{ subscriber.first_name }},

This is it. The final check-in for the Lefty Reset is now open.

Submit your final check-in here → nicothelefty.com/checkin/final
...
## EMAIL 11 — Day 63 (Winner Announcement)

**Subject:** And the winners are...
**Preview:** The Lefty Reset results are in. Congratulations to everyone who showed up.

Hey {{ subscriber.first_name }},

60 days. You did it.

Before the announcement — finishing this challenge is a win. You showed up for yourself for 60 days. That matters more than any prize.

Now — the results.

Grand Prize ($1,000 Cash) — [WINNER NAME]
Greatest % body weight lost among Premium members. Congratulations.

2nd Place — [WINNER NAME]
[Prize details.]

3rd Place — [WINNER NAME]
[Prize details.]
...
Over $5,000 in cash and prizes awarded. Every one of you who finished earned something — even if it's just knowing you did what you said you'd do.

What's next? Stay tuned. The community isn't going anywhere.
